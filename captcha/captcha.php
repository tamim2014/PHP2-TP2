	...
	<div id="contenu" style="margin-top:0; padding-top:0.8em; padding-bottom:2em; ">
        <div class="entree" >
			...
			<form action="corpsFic2.php" method="get" class="exo5"  style="padding-top:3em !important;  padding-bottom:1.2em ;">
			   ...
			   <table>
                 ...
                 <tr style="margin-top:0 !important;"><td style="padding-right:8em;"> <input type="checkbox" name="captcha" checked></td><td style="padding-left:0; padding-right:0; "><input type="image"  src="captcha.png"  height="48" style="cursor:not-allowed "></td></tr>	         			 
